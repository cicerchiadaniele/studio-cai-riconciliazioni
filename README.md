# Studio CAI – Registro Riconciliazioni (v1.0.0)
...
3. Il timbro verde compare solo se Airtable conferma tutti i record. In caso di errore a metà, "Riprova" invia solo i mancanti.
4. "Situazione" mostra tutti i condomini dal più indietro al più aggiornato (verde ≤ 7 gg, ocra ≤ 30, rosso oltre o mai).
